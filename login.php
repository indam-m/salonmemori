        ...
        <article class="glass">
            <font color="white">
                ...
                <div style="margin-bottom: 25px" class="input-group">
                    ...
                    <input id="login-username" type="text" class="form-control transparent-input-field" name="username" value="" placeholder="Username">                                        
                </div>
            
                <div style="margin-bottom: 25px" class="input-group">
                    <span class="input-group-addon transparent-input-field"><i class="glyphicon glyphicon-lock"></i></span>
                    <input id="login-password" type="password" class="form-control transparent-input-field" name="password" placeholder="Password">
                </div>
