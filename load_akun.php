...
$akuns = mysql_query("SELECT * FROM manager NATURAL JOIN karyawan") or die (mysql_error());
...
$akuns2 = mysql_query("SELECT * FROM kasir NATURAL JOIN karyawan") or die (mysql_error());
